...
from dataset.dataloader import DPODataset
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="PocketLLM DPO")
    ...
    parser.add_argument("--data_path", type=str, default="../dataset/data/dpo.jsonl", help="DPO训练数据路径")
