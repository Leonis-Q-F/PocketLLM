...
if __name__ == "__main__":
    ...
    parser.add_argument("--wandb_project", type=str, default="PocketLLM-Full-SFT", help="wandb项目名")
    ...
    if args.use_wandb:
        ...
        wandb_run_name = f"PocketLLM-Full-SFT-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
        wandb.init(
